...
// HasRoleBind applies the HasEdge predicate on the "role_bind" edge.
func HasRoleBind() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(RoleBindTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, RoleBindTable, RoleBindColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasRoleBindWith applies the HasEdge predicate on the "role_bind" edge with a given conditions (other predicates).
func HasRoleBindWith(preds ...predicate.RoleBinding) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(RoleBindInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, RoleBindTable, RoleBindColumn),
		)
