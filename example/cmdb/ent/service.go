...
func (e ServiceEdges) RoleBindingsOrErr() ([]*RoleBinding, error) {
	if e.loadedTypes[0] {
...
// was not loaded in eager-loading.
func (e ServiceEdges) ServersOrErr() ([]*Server, error) {
	if e.loadedTypes[1] {
...
// QueryRoleBindings queries the "role_bindings" edge of the Service entity.
func (s *Service) QueryRoleBindings() *RoleBindingQuery {
	return (&ServiceClient{config: s.config}).QueryRoleBindings(s)
}

// QueryServers queries the "servers" edge of the Service entity.
func (s *Service) QueryServers() *ServerQuery {
	return (&ServiceClient{config: s.config}).QueryServers(s)
}
