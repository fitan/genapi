...
func (m *RoleBindingMutation) SetStatus(b bool) {
	m.status = &b
}

// Status returns the value of the "status" field in the mutation.
func (m *RoleBindingMutation) Status() (r bool, exists bool) {
	v := m.status
	if v == nil {
		return
	}
...
// If the RoleBinding object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RoleBindingMutation) OldStatus(ctx context.Context) (v bool, err error) {
	if !m.op.Is(OpUpdateOne) {
...
// OwnerCleared reports if the "owner" edge to the ServiceTree entity was cleared.
...
// ProjectCleared reports if the "project" edge to the ServiceTree entity was cleared.
...
// ServiceCleared reports if the "service" edge to the ServiceTree entity was cleared.
...
// Where appends a list predicates to the ServiceTreeMutation builder.
func (m *ServiceTreeMutation) Where(ps ...predicate.ServiceTree) {
	m.predicates = append(m.predicates, ps...)
}
...
// RoleBindCleared reports if the "role_bind" edge to the RoleBinding entity was cleared.
