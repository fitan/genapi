...
func (uc *UserCreate) AddRoleBindIDs(ids ...int) *UserCreate {
	uc.mutation.AddRoleBindIDs(ids...)
	return uc
}

// AddRoleBind adds the "role_bind" edges to the RoleBinding entity.
func (uc *UserCreate) AddRoleBind(r ...*RoleBinding) *UserCreate {
	ids := make([]int, len(r))
	for i := range r {
		ids[i] = r[i].ID
	}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.RoleBindIDs(); len(nodes) > 0 {
