...
func (sc *ServerCreate) AddServiceIDs(ids ...int) *ServerCreate {
	sc.mutation.AddServiceIDs(ids...)
	return sc
}

// AddServices adds the "services" edges to the Service entity.
func (sc *ServerCreate) AddServices(s ...*Service) *ServerCreate {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return sc.AddServiceIDs(ids...)
}
...
func (sc *ServerCreate) createSpec() (*Server, *sqlgraph.CreateSpec) {
	...
	if nodes := sc.mutation.ServicesIDs(); len(nodes) > 0 {
