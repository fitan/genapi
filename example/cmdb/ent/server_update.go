...
func (su *ServerUpdate) AddServiceIDs(ids ...int) *ServerUpdate {
	su.mutation.AddServiceIDs(ids...)
	return su
}

// AddServices adds the "services" edges to the Service entity.
func (su *ServerUpdate) AddServices(s ...*Service) *ServerUpdate {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return su.AddServiceIDs(ids...)
}
...
func (su *ServerUpdate) ClearServices() *ServerUpdate {
	su.mutation.ClearServices()
	return su
}

// RemoveServiceIDs removes the "services" edge to Service entities by IDs.
func (su *ServerUpdate) RemoveServiceIDs(ids ...int) *ServerUpdate {
	su.mutation.RemoveServiceIDs(ids...)
	return su
}

// RemoveServices removes "services" edges to Service entities.
func (su *ServerUpdate) RemoveServices(s ...*Service) *ServerUpdate {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return su.RemoveServiceIDs(ids...)
}
...
func (su *ServerUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if su.mutation.ServicesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   server.ServicesTable,
			Columns: server.ServicesPrimaryKey,
			Bidi:    false,
	...
	if nodes := su.mutation.RemovedServicesIDs(); len(nodes) > 0 && !su.mutation.ServicesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   server.ServicesTable,
	...
	if nodes := su.mutation.ServicesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   server.ServicesTable,
...
// AddServiceIDs adds the "services" edge to the Service entity by IDs.
func (suo *ServerUpdateOne) AddServiceIDs(ids ...int) *ServerUpdateOne {
	suo.mutation.AddServiceIDs(ids...)
	return suo
}

// AddServices adds the "services" edges to the Service entity.
func (suo *ServerUpdateOne) AddServices(s ...*Service) *ServerUpdateOne {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return suo.AddServiceIDs(ids...)
}
...
// ClearServices clears all "services" edges to the Service entity.
func (suo *ServerUpdateOne) ClearServices() *ServerUpdateOne {
	suo.mutation.ClearServices()
	return suo
}

// RemoveServiceIDs removes the "services" edge to Service entities by IDs.
func (suo *ServerUpdateOne) RemoveServiceIDs(ids ...int) *ServerUpdateOne {
	suo.mutation.RemoveServiceIDs(ids...)
	return suo
}

// RemoveServices removes "services" edges to Service entities.
func (suo *ServerUpdateOne) RemoveServices(s ...*Service) *ServerUpdateOne {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return suo.RemoveServiceIDs(ids...)
}
...
func (suo *ServerUpdateOne) sqlSave(ctx context.Context) (_node *Server, err error) {
	...
	if suo.mutation.ServicesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   server.ServicesTable,
	...
	if nodes := suo.mutation.RemovedServicesIDs(); len(nodes) > 0 && !suo.mutation.ServicesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   server.ServicesTable,
	...
	if nodes := suo.mutation.ServicesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   server.ServicesTable,
