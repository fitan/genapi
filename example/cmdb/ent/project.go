...
func (e ProjectEdges) RoleBindingsOrErr() ([]*RoleBinding, error) {
	if e.loadedTypes[0] {
...
// QueryRoleBindings queries the "role_bindings" edge of the Project entity.
func (pr *Project) QueryRoleBindings() *RoleBindingQuery {
	return (&ProjectClient{config: pr.config}).QueryRoleBindings(pr)
}
