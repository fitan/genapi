...
//go:embed ent_fn_template/predicate.tmpl
var predicate_tmpl string

//go:embed ent_fn_template/curd.tmpl
var curd_tmplV2 string

//go:embed ent_fn_template/func.tmpl
var func_tmpl string

//go:embed ent_fn_template/includes.tmpl
var includesV2_tmpl string

//go:embed ent_fn_template/option.tmpl
var option_tmpl string

//go:embed ent_fn_template/new_obj.tmpl
var new_obj string

//go:embed ent_fn_template/router.tmpl
var router_tmpl string

//go:embed ent_fn_template/swagger_obj.tmpl
